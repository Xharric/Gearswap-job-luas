...
function init_gear_sets()
    ...
    -- Specific spells
    sets.midcast.Utsusemi = set_combine(sets.midcast.SpellInterrupt, {feet="Hattori Kyahan +1", back="Andartia's Mantle"})
...
--    sets.resting = {}
    ...
    -- Defense sets
    sets.defense.PDT = sets.idle.Meva
...
--    sets.buff.Migawari = {body="Hatttori Ningi +1"}
